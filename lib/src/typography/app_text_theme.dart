...
class AppTextTheme extends ThemeExtension<AppTextTheme> {
  ...
  static final AppTextTheme lightTextTheme = AppTextTheme(
    headingLarge: AppTextStyles.headingLarge.copyWith(color: AppColors.textHeading),
    headingMedium: AppTextStyles.headingMedium.copyWith(color: AppColors.textHeading),
    headingSmall: AppTextStyles.headingSmall.copyWith(color: AppColors.textHeading),
    titleLarge: AppTextStyles.titleLarge.copyWith(color: AppColors.textHeading),
    titleMedium: AppTextStyles.titleMedium.copyWith(color: AppColors.textHeading),
    ...
    bodyLargeMedium: AppTextStyles.bodyLargeMedium.copyWith(color: AppColors.textBody),
    bodyLargeSemiBold: AppTextStyles.bodyLargeSemiBold.copyWith(color: AppColors.textHeading),
    bodyMedium: AppTextStyles.bodyMedium.copyWith(color: AppColors.textBody),
    bodyMediumMed: AppTextStyles.bodyMediumMed.copyWith(color: AppColors.textBody),
    bodyMediumSemiBold: AppTextStyles.bodyMediumSemiBold.copyWith(color: AppColors.textBody),
    bodyCaption: AppTextStyles.bodyCaption.copyWith(color: AppColors.textCaption),
    bodyCaptionMedium: AppTextStyles.bodyCaptionMedium.copyWith(color: AppColors.textCaption),
    bodyCaptionSemiBold: AppTextStyles.bodyCaptionSemiBold.copyWith(color: AppColors.textCaption),
    bodySmall: AppTextStyles.bodySmall.copyWith(color: AppColors.textCaption),
    bodySmallMedium: AppTextStyles.bodySmallMedium.copyWith(color: AppColors.textCaption),
    bodySmallSemiBold: AppTextStyles.bodySmallSemiBold.copyWith(color: AppColors.textCaption),
  );

  static final AppTextTheme darkTextTheme = AppTextTheme(
    headingLarge: AppTextStyles.headingLarge.copyWith(color: AppColors.textOnColorHeading),
    headingMedium: AppTextStyles.headingMedium.copyWith(color: AppColors.textOnColorHeading),
    headingSmall: AppTextStyles.headingSmall.copyWith(color: AppColors.textOnColorHeading),
    titleLarge: AppTextStyles.titleLarge.copyWith(color: AppColors.textOnColorHeading),
    titleMedium: AppTextStyles.titleMedium.copyWith(color: AppColors.textOnColorHeading),
    titleSmall: AppTextStyles.titleSmall.copyWith(color: AppColors.textOnColorHeading),
    bodyLarge: AppTextStyles.bodyLarge.copyWith(color: AppColors.textOnColorBody),
    bodyLargeMedium: AppTextStyles.bodyLargeMedium.copyWith(color: AppColors.textOnColorBody),
    bodyLargeSemiBold: AppTextStyles.bodyLargeSemiBold.copyWith(color: AppColors.textOnColorHeading),
    bodyMedium: AppTextStyles.bodyMedium.copyWith(color: AppColors.textOnColorBody),
    bodyMediumMed: AppTextStyles.bodyMediumMed.copyWith(color: AppColors.textOnColorBody),
    bodyMediumSemiBold: AppTextStyles.bodyMediumSemiBold.copyWith(color: AppColors.textOnColorBody),
    bodyCaption: AppTextStyles.bodyCaption.copyWith(color: AppColors.textOnColorCaption),
    bodyCaptionMedium: AppTextStyles.bodyCaptionMedium.copyWith(color: AppColors.textOnColorCaption),
    bodyCaptionSemiBold: AppTextStyles.bodyCaptionSemiBold.copyWith(color: AppColors.textOnColorCaption),
    bodySmall: AppTextStyles.bodySmall.copyWith(color: AppColors.textOnColorCaption),
    bodySmallMedium: AppTextStyles.bodySmallMedium.copyWith(color: AppColors.textOnColorCaption),
    bodySmallSemiBold: AppTextStyles.bodySmallSemiBold.copyWith(color: AppColors.textOnColorCaption),
  );
