  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: defaultDecoration
          .copyWith(hintText: decoration?.hintText ?? hintText, labelText: decoration?.labelText ?? labelText, hintStyle: decoration?.hintStyle ?? hintStyle, fillColor: decoration?.fillColor ?? fillColor)
          .copyWith(
      ...
      contextMenuBuilder: contextMenuBuilder ?? (context, editableTextState) => AdaptiveTextSelectionToolbar.editableText(editableTextState: editableTextState),
