...
class AppAlertCard extends StatelessWidget {
  ...
  const AppAlertCard({super.key, this.type, this.onTap, this.title, this.description, this.actionText});
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(title ?? '-', style: context.textTheme.bodyCaptionSemiBold.copyWith(color: _textColor)),
                Visibility(
                  visible: description != null,
                  child: Text(description ?? '', style: context.textTheme.bodyCaption.copyWith(color: _textColor)),
                ),
                Visibility(
                  visible: onTap != null,
                  child: InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Text(actionText ?? 'OK', style: context.textTheme.bodyCaptionSemiBold.copyWith(color: AppColors.textPrimary)),
                    ),
                  ),
                ),
              ],
